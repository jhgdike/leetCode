...
class Solution(object):
    def robotSim(self, commands, obstacles):
        ...
        for obstacle in obstacles:
            obx.setdefault(obstacle[0], list()).append(obstacle[1])
            oby.setdefault(obstacle[1], list()).append(obstacle[0])

        cur_max = 0

        cur = [0, 0]
        direct = 0  # 0, 1, 2, 3 北、东、南、西
            ...
            if command == -1:
                ...
                if direct & 1:
                    ...
                    if cur[0] in obx:
                        ...
                        cur[1] += step * command
                cur_max = max(cur_max, cur[0] * cur[0] + cur[1] * cur[1])
        return cur_max


print(Solution().robotSim(
    [1, 2, -2, 5, -1, -2, -1, 8, 3, -1, 9, 4, -2, 3, 2, 4, 3, 9, 2, -1, -1, -2, 1, 3, -2, 4, 1, 4, -1, 1, 9, -1, -2, 5,
    ...
    [[-57, -58], [-72, 91], [-55, 35], [-20, 29], [51, 70], [-61, 88], [-62, 99], [52, 17], [-75, -32], [91, -22],
